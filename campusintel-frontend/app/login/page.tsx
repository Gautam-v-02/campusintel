  ...
  return (
    <div className="min-h-screen bg-[#070711] flex flex-col items-center justify-center relative overflow-hidden">
      ...
      <div className="relative z-10 glass glow-indigo rounded-2xl p-10 w-full max-w-[420px]">
        <h2 className="font-display text-2xl text-[#e8e6f8] mb-1">Welcome to CampusIntel</h2>
        <p className="text-[#6b7280] text-[13px] mb-8">Sign in with your college email to continue</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <input
              ...
              className="w-full h-12 rounded-[10px] bg-[#0f0f1a] border border-[#2a2a3d] px-4 text-[#e8e6f8] placeholder:text-[#4b4b6b] text-sm outline-none transition focus:border-indigo-500 focus:shadow-[0_0_0_3px_rgba(99,102,241,0.15)]"
            />
          </div>
          <div>
            <input
          ...
          <button
            id="signin-btn"
            type="submit"
            className="w-full h-12 bg-indigo-600 hover:bg-indigo-500 text-white rounded-[10px] text-sm font-semibold transition-all hover:-translate-y-px active:translate-y-0"
          >
            Sign In
          </button>
        </form>
        ...
        <div className="flex items-center gap-3 my-5">
          ...
          <span className="text-[#4b4b6b] text-xs">or</span>
          <div className="flex-1 h-px bg-[#2a2a3d]" />
        </div>

        <button
          id="google-signin-btn"
          className="w-full h-12 bg-transparent border border-[#2a2a3d] rounded-[10px] text-[#c4c4d8] text-sm font-medium flex items-center justify-center gap-3 transition hover:bg-white/5"
        >
        ...
        <p className="text-center mt-6 text-[13px] text-[#4b4b6b]">
          New to CampusIntel?{' '}
          <a href="/onboarding" className="text-indigo-400 hover:text-indigo-300 transition">Sign up</a>
        </p>
      </div>
